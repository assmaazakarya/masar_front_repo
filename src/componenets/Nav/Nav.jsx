...
<div className={style.navbar}>
           <div className={style.logo}>
                 <Link to='/' className={style.dec}><h3>Masar Academy</h3></Link>
           </div>
    <div className={style.links}>

          <Link to='/' className={style.decoration}>Home</Link>
          <Link to='/courses' className={style.decoration}>Courses
          <FontAwesomeIcon className={style.FontAwesomeIcon} icon={faCaretDown} />
          ...
          <Link to='/lesson' className={style.decoration}>Religious Lessons
          <FontAwesomeIcon className={style.FontAwesomeIcon} icon={faCaretDown} />
          <div class={style.dropdown_content}>
             <a href="#">Link 1</a>
             <a href="#">Link 2</a>
          ...
          <Link to='/about' className={style.decoration}>About</Link>
          <Link to='/contact' className={style.decoration}>Contact</Link>
    </div>
